...
def split_rulebook(info):
    ...
    chunks = [{"content": doc.page_content, "page": doc.metadata["page"] + 1, "file_path": file_path, "game_name": game_name} for doc in splitted_docs]
    return chunks
...
def index_rulebook(chunks, update=False):
    ...
    print(f"<HWP 데이터 Elasticsearch 색인> 완료")
